#ifndef _FUNC_SAFETY_H_
#define _FUNC_SAFETY_H_
...
#define MAX_FSM_TEST_BUF_LEN      64
...
#define VGA_DIFF_VALUE                  (2.00)

#define EMU_SAVE_WDG_TO_MEM_ADDR       (0x7f0100)
#define PERIOD_TO_MS                   (3 * 100000)
#define FUNC_SAFETY_FRAME_ID           0x123

extern bool external_wdt_on_flag;
extern bool external_wdt_test_flag;
extern uint32_t max20430_feed_dog_time_cnt;
extern bool bb_frame_start_flag;
extern bool ldo_set_part_flag;
extern uint8_t sm1_ldo_part_cnt;
