...
extern int32_t can_cli_register(uint32_t msg_id, can_cli_callback func);
...
int32_t tm08_can_case1_loopback(void *self, void *params, uint32_t len)
{
    ...
    can_cli_register(CAN_SCAN_SIGNAL_1_ID, can_scan_signal_3);
    //can_cli_register(0X7ffffff, can_scan_signal_0x7ffffff);
...
{
    can_cli_register(0x1, can_scan_signal_0X1);
    can_cli_register(CAN_SCAN_SIGNAL_1_ID, can_scan_signal_3);
    can_cli_register(0x1fffffff, can_scan_signal_0X1fffffff);
...
{
    can_cli_register(0x199, can_scan_signal_0x199);
    can_cli_register(0x200, can_scan_signal_0x200);
    can_cli_register(0x201, can_scan_signal_0x201);
    can_cli_register(0x300, can_scan_signal_0x300);
    can_cli_register(0x400, can_scan_signal_0x400);
    can_cli_register(0x401, can_scan_signal_0x401);
    can_cli_register(0x500, can_scan_signal_0x500);
...
{
    can_cli_register(CAN_SCAN_SIGNAL_1_ID, can_scan_signal_1);
    can_cli_register(CAN_SCAN_SIGNAL_2_ID, can_scan_signal_2);
...
int32_t tm08_can_case100_hal_switch_to_canfd_mode(void *self, void *params, uint32_t len)
{
    int32_t result = E_OK;
    can_config_t can_param;
    uint32_t test_data[4] = {0x111112222,0x33334444,0x55556666,0x77778888};
    int i = 10;
