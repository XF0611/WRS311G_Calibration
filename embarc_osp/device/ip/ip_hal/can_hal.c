...
volatile uint32_t assert_reset_flag = 0;
...
static can_xfer_t can_mode_default = {
            ...
            .filter_element = {
                    ...
                    {
                            /* element 3,for Car Inddor calib */
                            .frame_format = eSTANDARD_FRAME,
							.filter_type = eDUAL_ID,
							.filter_cfg = eRX_FIFO,
							.filter_id0 = 0x131,
                    ...
                    {
                            /* element 4,for ldac off to standby */
                            .frame_format = eSTANDARD_FRAME,
							.filter_type = eDUAL_ID,
							.filter_cfg = eRX_FIFO,
							.filter_id0 = 0x53B,
                    ...
                    {
                            /* element 5,for ldac off to standby */
                            .frame_format = eSTANDARD_FRAME,
							.filter_type = eDUAL_ID,
							.filter_cfg = eRX_FIFO,
							.filter_id0 = 0x533,
                    ...
                    {
                            /* element 6,for ldac off to standby */
                            .frame_format = eSTANDARD_FRAME,
							.filter_type = eDUAL_ID,
							.filter_cfg = eRX_FIFO,
							.filter_id0 = 0x532,
                    ...
                    {
                            /* element 7,frames that do not need to be received are placed in the buffer */
                            .frame_format = eSTANDARD_FRAME,
                            .filter_type = eRANGE,
                            .filter_cfg = eRX_BUF,
                            .filter_id0 = 0x0,
...
static int32_t can_internal_reset(uint32_t id)
{
        ...
        if(E_OK == result){
                ...
                chip_ver = otp_get_chip_ver();
                if (chip_ver == ALPS_M2_CHIP || chip_ver == ALPS_TEST_CHIP || chip_ver == ALPS_M0_CHIP || chip_ver == ALPS_M1_CHIP)
                {
